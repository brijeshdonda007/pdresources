          ...
          <tr>
           ...
           <!-- <tr>
            ...
            <tr>
  			...
  			<tr>
              <td width="15%"> Evaluation : <span class="star"> *</span></td>
              <td width="25%" align="left" valign="top"><input type="text" class="input" value="<?php echo $course_evaluation; ?>" name="course_evaluation" id="course_evaluation" /></td>
              <td width="60%" align="left" valign="top" class="error"><?php echo form_error('course_evaluation');?></td>
            </tr>
            ...
            <tr>
             ...
             <tr>
              <td width="15%">Is Reenrolled course?<span class="star"> *</span></td>
              <?php
			  $yes=$no='';
					if($course_reenrolment == 'Yes')
						$yes='checked="checked"';
					else
						$no='checked="checked"';
			  ?>
              <td width="10%" align="left" valign="top"><label><input type="radio" style="width:20px !important;"  value="Yes" name="course_reenrolment" <?php echo $yes;?> />Yes</label><label><input type="radio" style="width:20px !important;"  value="No" name="course_reenrolment" <?php echo $no;?>/>No</label></td>
              <td width="60%" align="left" valign="top" class="error"></td>
            </tr>                      
            <tr>
...
<script type="text/javascript">
	...
	$(document).ready(function() {  $("#course_objective").tokenInput("<?php echo site_url('admin/course/GetObjective'); ?>", 
									...
									$("#course_evaluation").tokenInput("<?php echo site_url('admin/course/GetEvaluation'); ?>", 
													{
														theme: "facebook",preventDuplicates: true,tokenLimit: 1,
														<?php if($evaluation_arr){ ?>
														prePopulate: <?php echo $evaluation_arr;  } ?>
													});	
