...
<div class="root_address">
  ...
  <a href="<?php echo site_url('admin/evaluation/question/'.$evaluation_id.'/s'); ?>" class="root_link">Question List</a>  <span class="root_vr">/</span>
  <a href="<?php echo site_url('admin/evaluation/option/'.$evaluation_id.'/'.$question_id.'/s'); ?>" class="root_link">Option List</a>
