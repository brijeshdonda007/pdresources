...
{
	function get_test($test_id ='',$srchKey='')
	{
		if($test_id == '')
		{
			$where='';
			...
			{				
				...
				$where  = " and test_name like '%".$srchKey."%'";
				$sql = "(select * from pdr_test_master where is_deleted ='N' and test_name like '".$srchKey."%' order by test_name) UNION 
						(select * from pdr_test_master where is_deleted ='N' and test_name like '%".$srchKey."%' order by test_name) ";
			}			
			else
			{				
				$sql = "select * from pdr_test_master where is_deleted ='N' order by test_name";
			}
		}
		else
		{
