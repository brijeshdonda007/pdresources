...
*/	
	...
	$('.aClick_btn').click(function(){
		if($(this).hasClass('open'))
		{
			$(this).removeClass('open');
			$(this).parent('.user_info_ribben_outer').children('.aAnimate_part').stop(true,true).animate({width:'0px'});
		}else{
			$(this).addClass('open');
			$(this).parent('.user_info_ribben_outer').children('.aAnimate_part').stop(true,true).animate({width:'640px'});
		}
	});
