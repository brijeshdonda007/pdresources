    ...
    <form name="delete_form" id="delete_form" action="<?php echo site_url('admin/test/deleteTest'); ?>" method="post" onsubmit="return giveNotation();" >
     ...
     <div class="page_btn_space_right">
      ...
      <?php
		...
		{
?>
        	<a href="<?php echo site_url('admin/test/addTest/'.$course_id); ?>" class="page_btn">Add</a>
      <?php
		}
?>
      ...
      <table cellpadding="0" cellspacing="0" border="0" class="page_table">
          ...
          <?php
            foreach($listArr as $list) {
              ...
              echo '<td><a href="'.site_url('admin/test/addTest/'.$course_id.'/'.$list['test_id']).'"> Edit </a> | ';
             /* if($list['profession_is_active '] == "Y") {
			  ...
			  echo '<a href="'.site_url('admin/test/deleteTest/'.$course_id.'/'.$list['test_id']).'"> Delete </a> | ';	              
...
<script type="text/javascript">
	...
	function deleteTest(course_id,id)
	{
		...
		{
			$.ajax({
				url: "<?php echo site_url('admin/test/deleteTest'); ?>/"+course_id+"/"+id,
