		...
		else
		{
			...
			else
			{
				...
				if($this->mdl_signup->saveUserData($data))
				{
					...
					//$body.= " Thank you for signing up with PDR.<br/><br/>";
	...
	function registerMail($u_name,$email,$link)
	{
		...
		$body='<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
				...
				<table width="596" border="0" cellspacing="0" cellpadding="0" bordercolor="#131516" align="center">
				  ...
				  <tr>
					 <td width="596" height="45" style="background:#2d3032; margin:0px; padding:0px; border-bottom:2px solid #131516; border-top:2px solid #131516; padding-left:18px; font-family:Tahoma, Geneva, sans-serif; font-size:14px; color:#FFF; font-weight:bold;"><span style="color:#00a4e8;">W</span>elcome to PDR</td>
				  </tr>
				  ...
				  <tr>
					...
					<tr>
					<td style="margin:0px; padding:0px 0px 20px 20px; font-size:12px; font-family:Tahoma, Geneva, sans-serif; color:#9c9b9b;" >Thank you for signing up with PDR.We welcome you to PDR</td>
					</tr>
					<tr>
					<td style="margin:0px; padding:0px 0px 20px 20px; font-size:12px; font-family:Tahoma, Geneva, sans-serif; color:#9c9b9b;" >Your account information with PDR is as below:</td>
					</tr>
					<tr>
...
//		$this->db->like('user_active','publish');
	...
	function sendMail1($emailId,$subject,$mail_body)
	{
		   ...
		   $mail->Username   = "";//moviesmarketing@gmail.com                                     // GMAIL username
		   $mail->Password   = "";//vasanimahesh                                           // GMAIL password
