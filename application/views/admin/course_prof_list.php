...
<div class="page">
  ...
  <div class="right_nav" style="width:98%">
    ...
    <form name="delete_form" id="delete_form" action="<?php echo site_url('admin/course/deleteProf/'); ?>" method="post" onsubmit="return giveNotation();" >
     
     <div class="page_btn_space_right">
      <div style="float:left; padding-top:5px;">
        <a href="<?php echo site_url('admin/course/addProfession/'); ?>" class="page_btn">Add</a>
      ...
      <table cellpadding="0" cellspacing="0" border="0" class="page_table">
          ...
          <?php		  
            foreach($listArr as $list) {
              ...
              echo '<td><a href="'.site_url('admin/course/addProfession/'.$list['course_pro_id']).'"> Edit </a> | ';
              if($list['is_active'] == "Y") {
              ...
              echo '<a href="javascript:deleteProf('.$list['course_pro_id'].')"> Delete </a></td>';
...
<script type="text/javascript">
	...
	function deleteProf(id)
	{
		...
		{
			$.ajax({
				url: "<?php echo site_url('admin/course/deleteProf/'); ?>/"+id,
