      ...
      <table cellpadding="0" cellspacing="0" border="0" class="page_table">
          ...
          <?php
            foreach($listArr as $list) {
			  ...
			  echo '| <a href="'.site_url('admin/course/restriction/'.$list['course_id']).'"> Add Restriction </a> ';			  
			  echo '| <a href="'.site_url('admin/managereview/index/'.$list['course_id']).'"> Manage Reviews </a> ';
			  echo '</td>';
              echo '</tr>';
            }
			if(count($listArr) == 0)
