...
<div class="page">  
  ...
  <!--Start [ Right Nav ]-->
  	<div class="page_title" style="margin-left:15px;">Edit Profession</div>
        ...
        <form action="" method="post" enctype="multipart/form-data">
          <table cellpadding="0" cellspacing="0" border="0" class="form_table" width="100%">
           ...
           <tr>
              ...
              <?php
			  $yes=$no='';
					if($profession_is_active == 'N')
						$no='checked="checked"';
					else
						$yes='checked="checked"';
			  ?>
              <td width="10%" align="left" valign="top"><label><input type="radio" style="width:20px !important;"  value="Y" name="profession_is_active" <?php echo $yes;?> />Yes</label><label><input type="radio" style="width:20px !important;"  value="N" name="profession_is_active" <?php echo $no;?>/>No</label></td>
