...
class Test extends CI_Controller
{
	...
	{	
		...
		$res = $this->mdl_test->get_test('',$searchtext);
		if($start == "s")
			$start = 0;
	...
	{		
		...
		if($this->form_validation->run() == FALSE || $file_error!='')
		{
			...
			$this->load->view('admin/header');
			$this->load->view('admin/test/addTest',$data);
			$this->load->view('admin/footer');
		}
		else
		{
			...
			$start = $this->session->userdata('start');			
				redirect('admin/test/index/'.$start);
		}
	}
...
#--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------#	
	function question($test_id,$start='0')
	{
		...
		$this->load->view('admin/header');
		$this->load->view('admin/test/test_question_list',$data);
		$this->load->view('admin/footer');
	}
	...
	{		
		...
		if($this->form_validation->run() == FALSE || $file_error!='')
		{
			...
			$this->load->view('admin/header');
			$this->load->view('admin/test/addQuest',$data);
			$this->load->view('admin/footer');
		}
		else
		{
...
#--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------#	
	...
	{	
		...
		$this->load->view('admin/header');
		$this->load->view('admin/test/question_option_list',$data);
		$this->load->view('admin/footer');
	}
	...
	{		
		...
		if($this->form_validation->run() == FALSE || $file_error!='')
		{
			...
			$this->load->view('admin/header');
			$this->load->view('admin/test/addOption',$data);
			$this->load->view('admin/footer');
		}
		else
		{
