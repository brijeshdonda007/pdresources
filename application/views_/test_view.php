...
<script type="text/javascript" language="javascript">
	...
	{		
		...
		{
			document.testForm.action ="<?php echo site_url('home/index/0');?>/"+test_id+"/"+offset;
...
?>
    <form name="testForm" method="post" >
        <div style="width:100%;"><div align="left"><strong>Status:</strong>Exam is <?php echo $completed ?>% completed.</div><div align="center"><a href="<?php echo site_url('home/StopTest/'.$course_id.'/'.$TestInfo['test_id'].'/'.$offset.'/'.$test_attampt);?>">Pause/Breack Test</a></div></div>
        <?php
                if($completed == 100)
                    echo '<a href="'.site_url('home/result/'.$course_id.'/'.$TestInfo['test_id']).'">See Final Result</a>';
    ?>
        ...
        <?php
            ...
            {           
        ?>
        <a href="<?php echo site_url('home/index/'.$course_id.'/'.$TestInfo['test_id'].'/'.$prev);?>" title="Previous">Previous</a>
        <?php
            }
        ?>
