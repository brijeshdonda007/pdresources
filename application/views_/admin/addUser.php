...
<div class="page">  
  ...
  <!--Start [ Right Nav ]-->
  	<div class="page_title" style="margin-left:15px;">Add User</div>
      ...
      <div class="form_parent">
        <form action="" method="post">
          <table cellpadding="0" cellspacing="0" border="0" class="form_table" width="100%">
          	...
          	<tr>
              <td width="15%">User Email : <span class="star"> *</span></td>
            ...
            <tr>
              <td>User Name : <span class="star"> *</span></td>
            ...
            <tr>
              <td>Re-type Password : <span class="star"> *</span></td>
            ...
            <tr>
              <td>Birth Date : <span class="star"> *</span></td>
